...
<div class="mod-field-wrapper">
    <div class="app-form-item">
        ...
        <div class="app-input-block">
            <el-input v-model="fieldParams.title" clearable></el-input>
        </div>
    </div>
    <div class="app-form-item" v-for="(val, key) in fieldParams.radios" :key="key">
        <label class="app-form-label">选项名称</label>
        <div class="app-input-block">
            <el-input v-model="val.label" clearable placeholder="请输入选项名..."></el-input>
        </div>
    </div>
    <div class="app-form-item">
