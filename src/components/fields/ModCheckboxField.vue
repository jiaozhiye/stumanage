...
<div class="mod-field-wrapper">
    ...
    <div class="app-form-item" v-for="(val, key) in fieldParams.checks" :key="key">
        <label class="app-form-label">新增选项</label>
        <div class="app-input-block">
...
export default {
    ...
    methods: {
        addItemHandle(){
            this.fieldParams.checks.push({
                label: ''
            })
        },
        removeItemHandle(index){
            this.fieldParams.checks.splice(index, 1)
        },
        submitHandle(){
