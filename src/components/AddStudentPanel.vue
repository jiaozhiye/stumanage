    ...
    <div class="app-form-item">
        ...
        <div class="app-input-block">
            <el-tree
                ...
                ref="tree"
                highlight-current
                :default-expanded-keys="[getPersonalInfo.deptId]"
                :default-checked-keys="[getPersonalInfo.id]"
                :props="defaultProps">
            </el-tree>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        insertInfo(callback){
            ...
            if (this.form.name == '' || this.form.school == ''){
                return this.$message({
                    message: '请正确填写学员信息再提交！',
                    type: 'warning'
                })
            }

            this.$http.post('/safe/student/save', {
